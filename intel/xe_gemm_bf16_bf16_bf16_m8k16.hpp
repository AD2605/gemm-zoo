...
#include "intel/kernels/xe_gemm_bf16_bf16_bf16_m8k16.hpp"
...
struct gemm_bf16_bf16_bf16_m8k16 {
  gemm_bf16_bf16_bf16_m8k16(std::size_t m, std::size_t n, std::size_t k,
                            sycl::queue& queue)
      : m(m), n(n), k(k) {
    ...
    return queue.submit([&](sycl::handler& cgh) {
      cgh.parallel_for(
          ...
          [=](sycl::nd_item<1> it) [[sycl::reqd_sub_group_size(16)]] {
            [[clang::always_inline]] intel::kernels::gemm_bf16_bf16_bf16_m8k16(
