#ifndef INTEL_GEMM_S8_S8_S32_M8k16_HPP
#define INTEL_GEMM_S8_S8_S32_M8k16_HPP

#include "intel/kernels/xe_gemm_s8_s8_s32_m8k16.hpp"
...
struct gemm_s8_s8_s32_m8k16 {
  gemm_s8_s8_s32_m8k16(std::size_t m, std::size_t n, std::size_t k,
                       sycl::queue& queue)
      : m(m), n(n), k(k) {
    ...
    return queue.submit([&](sycl::handler& cgh) {
      cgh.parallel_for(
          ...
          [=](sycl::nd_item<1> it) [[sycl::reqd_sub_group_size(16)]] {
            [[clang::always_inline]] intel::kernels::xe_gemm_s8_s8_s32_m8k16(
